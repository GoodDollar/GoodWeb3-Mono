...
export function AnalyticsProvider({ config, appProps, children }: IAnaliticsProviderProps): ReactNode | null {
  ...
  const capture = useCallback((exception: Error, fingerprint?: string[], tags?: object, extra?: object): void => {
    sdk?.capture?.(exception, fingerprint, tags, extra);
  }, [sdk])

  const identify = useCallback((identifier: string | number, email?: string, props?: object): void => {
