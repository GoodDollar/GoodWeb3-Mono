...
const Web3Component = (params: PageProps) => {
  ...
  useEffect(() => {
    if(!library) return
    void getRecentClaims(params.account,params.explorers,library, params.pools, true).then(recentClaims => setClaims(recentClaims));
  },[library, params])
...
getRecentClaimsExample.args = {
    pools: ["0x0d43131f1577310d6349baf9d6da4fc1cd39764c","0xDd1c12f197E6D1E2FBA15487AaAE500eF6e07BCA","0x43d72Ff17701B2DA814620735C39C620Ce0ea4A1"],
