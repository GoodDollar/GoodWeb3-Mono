...
const useFVLink = (chainId) => {
    const { chainId: defaultChainId } = (0, react_2.useGetEnvChainId)();
    const sdk = (0, react_2.useSDK)(false, "claim", chainId !== null && chainId !== void 0 ? chainId : defaultChainId);
    return (0, react_1.useMemo)(() => sdk === null || sdk === void 0 ? void 0 : sdk.getFVLink(chainId), [sdk, chainId]);
};
