import { _ as __extends, a as __assign, b as __spreadArray, c as __rest, d as __awaiter, e as __generator, f as commonjsGlobal, S as SupportedChainId, T as Token$1, i as invariant$2, W as WETH9, U as UNI_ADDRESS, G as G$ContractAddresses, N as NativeCurrency, F as Fraction, g as __read, h as __makeTemplateObject } from './addresses.js';
import 'react';
import './index.js';

var genericMessage = "Invariant Violation";
var _a$5 = Object.setPrototypeOf, setPrototypeOf = _a$5 === void 0 ? function (obj, proto) {
    obj.__proto__ = proto;
    return obj;
} : _a$5;
...
if (typeof self !== 'undefined') {
  ...
  root$9 = Function('return this')();
}

symbolObservablePonyfill(root$9);
...
var _a$3 = Array.prototype, forEach = _a$3.forEach, slice = _a$3.slice;
...
var AAVE_STAKING = (_a$1 = {},
    _a$1[SupportedChainId.MAINNET] = 'https://api.thegraph.com/subgraphs/name/aave/protocol-v2',
    _a$1[SupportedChainId.KOVAN] = 'https://api.thegraph.com/subgraphs/name/aave/protocol-v2-kovan',
    _a$1);
...
var USDT = new Token$1(SupportedChainId.MAINNET, '0xdAC17F958D2ee523a2206206994597C13D831ec7', 6, 'USDT', 'Tether USD');
var FEI = new Token$1(SupportedChainId.MAINNET, '0x956F47F50A910163D8BF957Cf5846D573E7f87CA', 18, 'FEI', 'Fei USD');
var TRIBE = new Token$1(SupportedChainId.MAINNET, '0xc7283b66Eb1EB5FB86327f08e1B5816b0720212B', 18, 'TRIBE', 'Tribe');
var FRAX = new Token$1(SupportedChainId.MAINNET, '0x853d955aCEf822Db058eb8505911ED77F175b99e', 18, 'FRAX', 'Frax');
var FXS = new Token$1(SupportedChainId.MAINNET, '0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0', 18, 'FXS', 'Frax Share');
var renBTC = new Token$1(SupportedChainId.MAINNET, '0xEB4C2781e4ebA804CE9a9803C67d0893436bB27D', 8, 'renBTC', 'renBTC');
var UMA = new Token$1(SupportedChainId.MAINNET, '0x04Fa0d235C4abf4BcF4787aF4CF447DE572eF828', 18, 'UMA', 'UMA Voting Token v1');
var ETH2X_FLI = new Token$1(SupportedChainId.MAINNET, '0xAa6E8127831c9DE45ae56bB1b0d4D4Da6e5665BD', 18, 'ETH2x-FLI', 'ETH 2x Flexible Leverage Index');
/* Mirror Protocol compat. */
var UST = new Token$1(SupportedChainId.MAINNET, '0xa47c8bf37f92abed4a126bda807a7b7498661acd', 18, 'UST', 'Wrapped UST');
var MIR = new Token$1(SupportedChainId.MAINNET, '0x09a3ecafa817268f77be1283176b946c4ff2e608', 18, 'MIR', 'Wrapped MIR');
var FUSE = new (/** @class */ (function (_super) {
    ...
    Object.defineProperty(class_1.prototype, "wrapped", {
        get: function () {
            ...
            !weth9 ? invariant$2(false, 'WRAPPED') : void 0;
            return weth9;
        },
        enumerable: false,
        configurable: true
...
var WETH9_EXTENDED = __assign(__assign({}, WETH9), (_a = {}, _a[SupportedChainId.FUSE] = new Token$1(SupportedChainId.FUSE, '0x0BE9e53fd7EDaC9F859882AfdDa116645287C629', 18, 'WETH9', 'Wrapped Fuse'), _a));
var USDC = (_b = {},
    _b[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 6, 'USDC', 'USD//C'),
    _b[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, '0xb7a4F3E9097C08dA09517b5aB877F7a917224ede', 6, 'USDC', 'USD//C'),
    _b[SupportedChainId.FUSE] = new Token$1(SupportedChainId.FUSE, '0x620fd5fa44BE6af63715Ef4E65DDFA0387aD13F5', 6, 'USDC', 'USD//C'),
    _b);
var UNI = (_c = {},
    _c[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, UNI_ADDRESS[1], 18, 'UNI', 'Uniswap'),
    _c[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, UNI_ADDRESS[42], 18, 'UNI', 'Uniswap'),
    _c[SupportedChainId.FUSE] = new Token$1(SupportedChainId.FUSE, '0xFcF3Bd3AEa648558B4f71499762558326E8F1077', 18, 'UNI', 'Uniswap'),
    _c);
var G$ = (_d = {},
    _d[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, G$ContractAddresses(SupportedChainId.MAINNET, 'GoodDollar'), 2, 'G$', 'GoodDollar'),
    _d[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, G$ContractAddresses(SupportedChainId.KOVAN, 'GoodDollar'), 2, 'G$', 'GoodDollar'),
    _d[SupportedChainId.ROPSTEN] = new Token$1(SupportedChainId.KOVAN, G$ContractAddresses(SupportedChainId.ROPSTEN, 'GoodDollar'), 2, 'G$', 'GoodDollar'),
    _d[SupportedChainId.FUSE] = new Token$1(SupportedChainId.FUSE, G$ContractAddresses(SupportedChainId.FUSE, 'GoodDollar'), 2, 'G$', 'GoodDollar'),
    _d);
var GDX = (_e = {},
    _e[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, G$ContractAddresses(SupportedChainId.MAINNET, 'GoodReserveCDai'), 2, 'G$X', 'GoodDollar X'),
    _e[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, G$ContractAddresses(SupportedChainId.KOVAN, 'GoodReserveCDai'), 2, 'GDX', 'GoodDollar X'),
    _e[SupportedChainId.ROPSTEN] = new Token$1(SupportedChainId.ROPSTEN, G$ContractAddresses(SupportedChainId.ROPSTEN, 'GoodReserveCDai'), 2, 'GDX', 'GoodDollar X'),
    _e);
var GDAO = (_f = {},
    _f[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, G$ContractAddresses(SupportedChainId.MAINNET, 'GReputation'), 18, 'GOOD', 'GoodDollar Reputation'),
    _f[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, G$ContractAddresses(SupportedChainId.KOVAN, 'GReputation'), 18, 'GOOD', 'GoodDollar Reputation'),
    _f[SupportedChainId.ROPSTEN] = new Token$1(SupportedChainId.ROPSTEN, G$ContractAddresses(SupportedChainId.ROPSTEN, 'GReputation'), 18, 'GOOD', 'GoodDollar Reputation'),
    _f[SupportedChainId.FUSE] = new Token$1(SupportedChainId.FUSE, G$ContractAddresses(SupportedChainId.FUSE, 'GReputation'), 18, 'GOOD', 'GoodDollar Reputation'),
    _f);
var DAI = (_g = {},
    _g[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, G$ContractAddresses(SupportedChainId.MAINNET, 'DAI'), 18, 'DAI', 'Dai Stablecoin'),
    _g[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, G$ContractAddresses(SupportedChainId.KOVAN, 'DAI'), 18, 'DAI', 'Dai Stablecoin'),
    _g[SupportedChainId.ROPSTEN] = new Token$1(SupportedChainId.ROPSTEN, G$ContractAddresses(SupportedChainId.ROPSTEN, 'DAI'), 18, 'DAI', 'Dai Stablecoin'),
    _g);
var CDAI = (_h = {},
    _h[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, G$ContractAddresses(SupportedChainId.MAINNET, 'cDAI'), 8, 'cDAI', 'Compound DAI'),
    _h[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, G$ContractAddresses(SupportedChainId.KOVAN, 'cDAI'), 8, 'cDAI', 'Compound DAI'),
    _h[SupportedChainId.ROPSTEN] = new Token$1(SupportedChainId.ROPSTEN, G$ContractAddresses(SupportedChainId.ROPSTEN, 'cDAI'), 8, 'cDAI', 'Compound DAI'),
    _h);
var WBTC = (_j = {},
    _j[SupportedChainId.MAINNET] = new Token$1(SupportedChainId.MAINNET, '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', 8, 'WBTC', 'Wrapped BTC'),
    _j[SupportedChainId.KOVAN] = new Token$1(SupportedChainId.KOVAN, '0xd3a691c852cdb01e281545a27064741f0b7f6825', 8, 'WBTC', 'Wrapped BTC'),
    _j);
var TOKEN_LISTS = (_k = {},
...
export { WBTC as A, UNI as B, UMA as C, DAI as D, ETH2X_FLI as E, FUSE as F, G$ as G, FEI as H, TRIBE as I, FRAX as J, FXS as K, renBTC as L, MIR as M, AMPL as N, aaveStaking as O, CDAI as P, debugGroupEnd as Q, debugGroup as R, getClient as S, TOKEN_LISTS as T, UnsupportedChainId as U, WETH9_EXTENDED as W, _isFlattenable as _, isArguments_1 as a, isBuffer as b, isTypedArray_1 as c, isFunction_1 as d, isLength_1 as e, _Stack as f, g$Price as g, _equalArrays as h, isArray_1 as i, _equalByTag as j, _getTag as k, isObjectLike_1 as l, isObject_1 as m, isSymbol_1 as n, _baseToString as o, _stringToPath as p, _arrayMap as q, GDX as r, GDAO as s, debug as t, memoize_1 as u, decimalToFraction as v, delayedCacheClear as w, UST as x, USDC as y, USDT as z };
